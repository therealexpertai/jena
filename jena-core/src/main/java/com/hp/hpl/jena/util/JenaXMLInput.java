 ...
 * problems.
 *
 * EXPERT.AI: credits https://github.com/apache/jena/blob/jena-4.2.0/jena-core/src/main/java/org/apache/jena/util/JenaXMLInput.java
 */
public class JenaXMLInput {

    private static Logger log = LoggerFactory.getLogger(JenaXMLInput.class) ;
    ...
    private static void setXMLInputFactoryProperty(XMLInputFactory xf, String name, Object value) {
        try {
            ...
            log.error("Problem setting StAX property - name: \"" +
